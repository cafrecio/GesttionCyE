        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Listado de Localidades</h1>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Tabla de Localidades</h3>
                                    <div class="card-tools">
                                        <a href="{{ route('localidades.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Nueva Localidad</a>
                                    </div>
                                </div>
